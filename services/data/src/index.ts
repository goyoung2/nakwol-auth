...
app.delete('/v1/game-accounts/:accountId/equipment/:equipmentId', (c) => handleDeleteEquipment(c.req.param('accountId'), c.req.raw, c.env));
...
app.delete('/v1/game-accounts/:accountId/decks/:deckId', (c) => handleDeleteDeck(c.req.param('accountId'), c.req.raw, c.env));
